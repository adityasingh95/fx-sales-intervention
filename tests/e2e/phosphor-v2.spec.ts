...
test('phosphor v2 screenshot', async ({ page }) => {
  ...
  // Open the Off Hours INTERVENE deal to show ticket with AI suggestion + rate cells
  ...
  await page.screenshot({ path: '/tmp/theme-phosphor-v2.png', fullPage: true });
});
