...
export default function TicketFooter({
  ...
  return (
    <footer
      ...
      className="flex flex-wrap items-center justify-end gap-1 border-t border-black/8 bg-white/15 px-2 py-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.9)] sm:gap-2 sm:px-5"
    >
      {showReturnToStream && (
        <ActionButton
